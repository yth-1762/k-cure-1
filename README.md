...
- 독립변수: 흡연유형, AGE,SEX,BMI,INCOME,CCI_SCORE(상병점수),physical activity, STAGE(수술부위),수술여부,방사선치료여부,전신항암요법치료여부,
- 목적: 표본1(30550명)을 대상으로 cox proportional hazard regression을 활용하여 사망(ALL cause mortality/Lung cancer mortality/Non Lung cancer mortality)에 영향을 미치는 요인 분석
